...
if (isset($_POST['edit_photo'])) :
  ...
  $stmt = $pdo->prepare('SELECT username, photo FROM user WHERE id_user = :id');
  $stmt->execute([':id'=>$id]);
  ...
  if(!isset($errMSG)) :
    $stmt = $pdo->prepare('UPDATE user SET photo = :photo WHERE id_user = :id');
...
if (isset($_POST['edit_user'])) :
  ...
  if(!isset($errMSG)) :
    $stmt = $pdo->prepare('UPDATE user SET name = :name, username = :username,
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <figure class="avatar mr-2 avatar-xl mb-3">
                  ...
                  ?>
                  <img src="../assets/img/avatar/<?= $photo ?>" alt="...">
                </figure>
              </div>
            ...
            <form method="POST" action="">
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <?php
                    $query_level = "SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'user' AND COLUMN_NAME = 'level'";
                    $r_level = $pdo->query($query_level);

                    foreach ($r_level as $r_lvl) :
                      $enumList = explode(",", str_replace("'", "", substr($r_lvl['COLUMN_TYPE'], 5, (strlen($r_lvl['COLUMN_TYPE'])-6))));
