        ...
        <div class="card-body">
          <form method="POST" action="">
            <div class="form-group">
              <label for="no_car">Nomor Mobil</label>
              <input type="text" class="form-control" name="no-car" id="no-car" placeholder="xx xxxx xx" required autocomplete="off">
            </div>
            <div class="form-group">
              <label for="type">Tipe</label>
              <input type="tel" class="form-control" name="type" id="type" placeholder="Cth.: Suzuki Carry1.5" autocomplete="off">
            </div>
