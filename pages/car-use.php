...
if(isset($_POST["submit"])) :
  if (add_business_trip($_POST) > 0) :
    ...
    //       window.location.replace('./car-availability.php');
    //     }, 3000);
    //   </script>
    // ";
    setcookie("success", "
        <div class='alert alert-success alert-dismissible show fade'>
          <div class='alert-body'>
            ...
            Mobil berhasil digunakan. Silahkan periksa <a href='./data-business-trip.php'>Data Perjalanan</a>.
          </div>
        </div>", time()+5); //5 detik
    header("Location: ./car-availability.php");
  else :
    // echo "
    //   <script type='text/javascript'>
    //     setTimeout(function() {
      ...
      <section class="section">
        ...
        <div class="alert alert-info alert-has-icon">
          ...
          <div class="alert-body">
            ...
            Mobil yang akan digunakan pada halaman sebelumnya, terpilih secara otomatis.
          </div>
        </div>
        <div class="alert alert-info alert-has-icon">
          <div class="alert-icon"><i class="far fa-lightbulb"></i></div>
              ...
              <?php
                ...
                foreach ($result_car as $row_car) :
                  ...
                  if($a && $b && $c && $d && $e && $f && $g && $h && $i && $j) :
                    if($_GET['no_car'] == $row_car['no_car']) :
                      $select = "selected";
                    else :
                      $select = "";
                    endif;
              
                      echo "<option value='".$row_car['no_car']."' ".$select.">".$row_car['no_car']." (".$row_car['type'].")</option>";
